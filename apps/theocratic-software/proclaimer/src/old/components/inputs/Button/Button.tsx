import widths, { WidthsType } from "apps/theocratic-software/proclaimer/src/old/components/inputs/styles2/widths";
import { useLongPress } from "apps/theocratic-software/proclaimer/src/old/services/utility/useLongPress";
